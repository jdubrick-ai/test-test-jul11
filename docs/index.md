...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-test-jul11](https://github.com/jdubrick-ai/test-test-jul11)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-test-jul11-gitops](https://github.com/jdubrick-ai/test-test-jul11-gitops)

# **Usage**

To access the test-test-jul11 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of rhdh-test. You can access this namespace through the web console or via your CLI.
