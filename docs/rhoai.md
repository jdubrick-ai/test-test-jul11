...
2) Go to the `Data Science Projects` section and access your application's project named `rhdh-test`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `test-test-jul11-notebook`.
...
5) In the terminal, run `cd test-test-jul11` to navigate to your sample app's directory.
